                        ...
                        <div class="p-5 sm:p-6 flex flex-col justify-between w-full">
                            ...
                            <div class="mt-4 flex items-center justify-between">
                                <div class="flex items-center gap-3">
                                    ...
                                    <p class="text-4xl font-semibold leading-none">{{ number_format($stats['totalEmployees']) }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="p-5 sm:p-6 flex flex-col justify-between w-full">
                            ...
                            <div class="mt-4 flex items-center justify-between">
                                <div class="flex items-center gap-3">
                                    ...
                                    <p class="text-4xl font-semibold leading-none">{{ number_format($stats['verifiedEmployees']) }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
