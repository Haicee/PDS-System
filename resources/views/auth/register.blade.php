    ...
    <div class="flex items-center justify-center px-4">
        <section class="w-full max-w-3xl rounded-3xl border border-white/10 bg-white/60 p-8 shadow-2xl backdrop-blur max-h-[75vh] overflow-y-auto hide-scrollbar">
            ...
            <form id="register-form" method="POST" 
                ...
                <!-- Offline mode: network modal disabled. Original kept for future use.
...
<script>
// Offline mode: network check removed. Data stored directly in DB.
function handleRegisterSubmit() {
    // Offline mode: navigator.onLine gate disabled. Original kept for future use.
    // if (!navigator.onLine) { this.showNetworkError = true; return; }
