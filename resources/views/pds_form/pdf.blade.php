...
<table class="w-full border-collapse table-fixed text-base" style="font-family:'Arial Narrow','sans-serif'; border:4px solid black; border-top:0;">
  ...
  <tr>
    <td class="border h-8 text-center align-middle" style="border-top:0; font-size:30px !important; font-weight:700 !important; font-style:italic !important;">
      SIGNATURE
    </td>
    <td class="border" colspan="2" style="height:60px; border-top:0;">
    ...
    @include('pdsreview.partials.date-format-helper')
    <td colspan="3" class="border h-10" style="border-top:0;">
...
<table class="w-full border-collapse table-fixed text-base" style="font-family:'Arial Narrow','sans-serif'; border:4px solid black; border-top:0;">
  ...
  <tr>
    <td class="border h-8 text-center align-middle" style="border-top:0; font-size:30px !important; font-weight:700 !important; font-style:italic !important;">SIGNATURE</td>
    <td class="border" colspan="2" style="height:60px; border-top:0;">
      <div style="height:60px; width:100%; display:flex; align-items:center; justify-content:center; overflow:hidden;">
        @if($signatureUrl)
          <img src="{{ $signatureUrl }}" alt="Signature" style="max-height:55px; max-width:100%; object-fit:contain;">
...
<style>
#page2-inner td, #page2-inner th, #page2-inner span, #page2-inner div {
  font-size: 13px !important;
}
#page2-inner th[colspan="6"] {
  font-size: 18px !important;
}
#page2-inner th[colspan="6"] span {
  font-size: 15px !important;
}
#page2-inner .text-xl, #page2-inner .text-lg {
  font-size: 13px !important;
}
</style>
