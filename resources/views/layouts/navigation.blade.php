        ...
        <div class="flex justify-between h-20">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center gap-2 sm:gap-3 pl-2 sm:pl-4">
                    ...
                    <img src="{{ asset('images/bfar-xlogo.png') }}" class="h-10 w-auto sm:h-14"/>
                    <img src="{{ asset('images/gad-logo.jpg') }}" class="h-10 w-auto sm:h-14"/>
                </div>

                <!-- Navigation Links  -->
                <div class="hidden space-x-8 sm:-my-px sm:ms-6 sm:flex">
                    <x-nav-link :href="route('dashboard')" :active="request()->routeIs('dashboard')" class="font-semibold text-xs md:text-base">
                        {{ __('Dashboard') }}
                    </x-nav-link>
                </div>
                ...
                <!-- PDS form screen -->
                <div class="hidden space-x-8 sm:-my-px sm:ms-6 sm:flex">
                    <x-nav-link :href="route('pds.form')" :active="request()->routeIs('pds.form')" class="font-semibold text-xs md:text-base">
                        {{ __('PDS Review') }}
                    </x-nav-link>
                </div>x
                ...
                <!-- Manage User screen -->
                <div class="hidden space-x-8 sm:-my-px sm:ms-6 sm:flex">
                    <x-nav-link :href="route('manage-user')" :active="request()->routeIs('manage-user')" class="font-semibold text-xs md:text-base">
                        {{ __('Manage Employees') }}
                    </x-nav-link>
                </div>
...
@php
    $currentAdminId = optional(Auth::guard('admin')->user())->id ?? Auth::id();
@endphp
<script>
    window.currentAdminId = {{ $currentAdminId ?? 'null' }};
</script>
    ...
    <div x-cloak x-show="open" x-transition.origin.top.right @click.outside="open = false" class="sm:hidden absolute right-3 top-16 w-64 bg-white shadow-xl rounded-2xl border border-gray-100 overflow-hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('pds.form')" :active="request()->routeIs('pds.form')">
                {{ __('PDS Review') }}
            </x-responsive-nav-link>
            <x-responsive-nav-link :href="route('manage-user')" :active="request()->routeIs('manage-user')">
                {{ __('Manage Employees') }}
            </x-responsive-nav-link>
        </div>
